            ...
            <div className="max-w-7xl mx-auto p-4 sm:p-6">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            {subjectsLoading ? (
                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
                                    {subjects.map((name, index) => (
                                        <button key={name} className="flex flex-col items-center p-2 sm:p-3 bg-white border border-gray-200 rounded-lg hover:shadow-md transition-shadow">
                                            {/* Outer circle */}
                    ...
                    <div className="space-y-4 sm:space-y-6">
                        ...
                        {/* Refer & Earn */}
                        <div className="bg-[#FFFCF4] border border-gray-200 rounded-2xl p-3 sm:p-2 max-w-sm mx-auto shadow-sm">
                            {/* Illustration */}
                        ...
                        {/* Take Quiz */}
                        <div className="bg-[#F5F6FA] border border-gray-200 rounded-lg p-3 sm:p-4">
                            <div className="flex items-center justify-between mb-3">
                                <h3 className="font-semibold text-gray-900 text-sm sm:text-base">Take your first quiz</h3>
                                <div className="flex items-center space-x-1">
                                    <Image src={LeoCoin} alt="LeoCoin" width={16} height={16} className="w-4 h-4 object-contain" />
                                    <span className="font-semibold text-gray-700 text-sm">100</span>
                                </div>
                            </div>

                            <p className="text-xs sm:text-sm text-gray-600 mb-4">Ex-founders are always treated with respect for whatever hustle they have put into</p>

                            <button className="w-full py-2 bg-[#714B90] text-white rounded-lg hover:bg-[#5a3a73] transition-colors text-sm sm:text-base">
                                Enter Classroom
                            </button>
                        </div>
                    </div>
