...
export default function EditProfileModal({ open, onClose, profile }: EditProfileModalProps) {
    ...
    }, [firstName, lastName, userType, board, grade, studentName])
    ...
    const handleSave = useCallback(async (e: React.FormEvent) => {
        ...
        try {
            ...
            onClose()
            // Optionally refresh to reflect latest profile
                    ...
                    <form className="space-y-4" onSubmit={handleSave}>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="tel" value={phone} onChange={(e) => setPhone(e.target.value)} className="w-full p-3 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-400" placeholder="Enter phone number" />
                            </div>
                        </div>
