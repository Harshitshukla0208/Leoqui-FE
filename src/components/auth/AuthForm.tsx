...
const COGNITO_URL = 'https://ap-south-1y869sqwls.auth.ap-south-1.amazoncognito.com/oauth2/authorize?identity_provider=Google&client_id=49k7a6vngf7agubj6b1hrljfj1&response_type=code&redirect_uri=http://localhost:3000/login&scope=aws.cognito.signin.user.admin%20email%20openid%20profile&prompt=select_account'
